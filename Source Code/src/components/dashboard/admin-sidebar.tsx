...
import { Home, Inbox, Link2, User as UserIcon, LogOutIcon, Settings, Moon, Sun, BarChart3 } from "lucide-react"
...
const adminMenuItems = [
  { title: 'Analytics', icon: BarChart3, href: '/user-dashboard/analytics' },
];
          ...
          <SidebarMenuItem>
            <SidebarMenuButton size="lg">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold text-sm flex items-center gap-2">
                    {user?.name}
                    {isAdmin && (
